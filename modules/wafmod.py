# https://github.com/EnableSecurity/wafw00f/blob/master/wafw00f/main.py - this is the original file that outputs scan results to WAF.
# It's edited main.py to work with the scanner.
